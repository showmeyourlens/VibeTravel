    ...
    <div className="space-y-4">
      ...
      <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
        <p className="text-sm text-amber-900">
          💡 <span className="font-semibold">Pro tip:</span> The more details you provide, the better we can personalize your itinerary!
        </p>
      </div>

      {/* Generate Button */}
      <div className="mt-8 pt-6 border-t border-slate-200">
        <Button onClick={onGenerate} disabled={isGenerating} size="lg" className="w-full gap-2 py-6 text-lg">
